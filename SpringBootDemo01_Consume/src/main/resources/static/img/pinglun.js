function LoadCommets(id, page) {
    ...
    var waithtml = "<div style='line-height:50px'>���ۼ�����...</div>";
...
function PostComment(cid) {
    ...
    var waithtml = "<div style='line-height:30px'>���ڷ�����...</div>";
    if (f.msg.value == '') {
        alert("���ݲ���Ϊ�գ�");
        return;
    }
...
window._bd_share_config = {
    "common": {
        ...
        "bdText": "",
        "bdMini": "2",
        "bdMiniList": ["qzone", "tsina", "bdysc", "weixin", "douban", "bdhome"],
        "bdPic": cpic,
        "bdStyle": "0",
        "bdSize": "16"
    }, "share": {}
