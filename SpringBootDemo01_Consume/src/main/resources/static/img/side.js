/* 
 * http://www.yinshiweb.com/ by ��ߵĶ���
 * 12-12-09
*/
jQuery(function ($) {
    var enableSticky, stickyTag, stickyTagWrapper, main, side, stickyStartHeight, stickyEndHeight, stickyHeight,
        MARGIN_TOP, MARGIN_BOTTOM, WINDOW_MIN_HEIGHT;
...
// else if (currentScrollTop< stickyEndHeight) {  ����ļ��˶��ϵ�margin
